...
async def signup(
    ...
    agent_config = AgentConfig(
        ...
        agent_greeting=template.agent_greeting if template else "Thank you for visiting our website today... it will be my pleasure to help you",
...
async def demo_token(
    ...
    if not client:
        ...
        agent_config = AgentConfig(
            ...
            agent_greeting="Thank you for visiting our website today... it will be my pleasure to help you",
