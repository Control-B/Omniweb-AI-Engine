...
_register(IndustryConfig(
    ...
    qualification_fields=[
        ...
        {"name": "caller_email", "label": "Email", "required": False, "ask": "What's the best email to reach you?"},
        {"name": "caller_phone", "label": "Phone", "required": False, "ask": "Can I get a phone number for follow-up?"},
    ...
    example_greetings={
        "lead_qualifier": "Hi! Thanks for reaching out. I'd love to learn about what you need so I can connect you with the right solution. What brings you here today?",
        "customer_service": "Hello! I'm here to help with any questions or issues. What can I assist you with?",
        "general_assistant": "Hi there! How can I help you today?",
    },
))
...
_register(IndustryConfig(
    ...
    qualification_fields=[
        {"name": "caller_name", "label": "Name", "required": True, "ask": "Can I get your name?"},
        {"name": "caller_phone", "label": "Phone", "required": True, "ask": "What's the best number to reach you?"},
        {"name": "caller_email", "label": "Email", "required": False, "ask": "And your email for the estimate?"},
...
_register(IndustryConfig(
    ...
    qualification_fields=[
        {"name": "caller_name", "label": "Name", "required": False, "ask": "What's your name?"},
        {"name": "caller_email", "label": "Email", "required": True, "ask": "What email is your order under?"},
